...
class TopFragment : Fragment() {
    ...
    private class CardAdapter constructor(val cardNumbers: IntArray, val introList: ArrayList<String>, val titleList:ArrayList<String>, val companyList:ArrayList<String>) :
...
//                dragHandleView = itemView.findViewById(R.id.cat_card_list_item_drag_handle)
            ...
            fun bind(cardNumber: Int, titleList: ArrayList<String>, introList: ArrayList<String>, companyList: ArrayList<String>, itemTouchHelper: ItemTouchHelper?) {
                ...
                secTitleView.text =
                    String.format(Locale.getDefault(), companyList.get(cardNumber-1), cardNumber)
                despView.text =
