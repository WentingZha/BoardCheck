...
import com.zwt.boardcheck.databases.AppDatabase
import com.zwt.boardcheck.databases.TopDAO
import dagger.Binds
...
object DatabaseModule {
    ...
    @Provides
    fun provideTaskDao(database: AppDatabase): TopDAO = database.TopDAO()
}
